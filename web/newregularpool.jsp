...
<html>
    ...
    %> 
    <body><form action="./newregularpool" method="post">
            <div id="main">
                ...
                <div id="content">
                    ...
                    <div id="side">
                        ...
                        <br><br><center><table border="0">
                                ...
                                <h3>Create a new Regular Car Pool</h3>
                                ...
                                <tr>
                                    <td>Frequency</td>
                                    <td><input type="radio" name="t6" value="Everyday" />Everyday</td>
                                <tr><td></td><td><input type="radio" name="t6" value="Weekdays" />Weekdays</td></tr>
                                <tr><td></td><td>  <input type="radio" name="t6" value="Weekly" />Weekly(on days selected below)</td></tr>
                                <tr><td><input type="checkbox" name="t7" value="Sunday" />Sunday|
                                        <input type="checkbox" name="t7" value="Monday" />Monday|
                                        <input type="checkbox" name="t7" value="Tuesday" />Tuesday|
                                        <input type="checkbox" name="t7" value="Wednesday" />Wednesday|
                                        <input type="checkbox" name="t7" value="Thursday" />Thursday|
                                        <input type="checkbox" name="t7" value="Friday" />Friday|
                                        <input type="checkbox" name="t7" value="Saturday" />Saturday
