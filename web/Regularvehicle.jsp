...
<html>
    ...
    <body><form action="regularvehiclepool.jsp" method="post">
        <div id="main">
            ...
            <div id="content">
                <center><b><font style="font: monospace;size: 8px;color: maroon;" > <h2>Find the Regular Vehicle Pool Here</h2>
                    ...
                    <input type="submit" value="Search" size="50" height="15px"></font></b></center>
